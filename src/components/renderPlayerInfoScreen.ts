...
const renderPlayerInfoScreen = function (playerName_: string) {
	...
	pipe(
		addTextToElem(
			`Shall we allow our audacious enemies to violate with impunity the territory of the Kingdom? Will you permit the fleet to escape which has carried terror into your families? You will not! March, then, to meet them. Teach the galaxy that a malediction attends those that violate the territory of the Star Kingdom and her allies!`
		),
