...
},{"./renderPlayerBoard":"fC1Ui","./renderShipSelectionBttns":"cYI77","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./renderPlayerInfoScreen":"3f75x"}],"fC1Ui":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"cYI77":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../events/handleAxisToggleClick":"CL021","../events/handleCarrierBttnClick":"38NmJ","../events/handleSuperdreadnoughtBttnClick":"iL6A7","../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../events/handleBattleshipBttnClick":"4YxkI","../events/handleDestroyerBttnClick":"1zjy0","../events/handleFrigateBttnClick":"4QZ7c"}],"CL021":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"38NmJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./handleCarrierCellClick":"2p5Tx","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleCarrierMouseEnter":"g59nL","./handleCarrierMouseLeave":"ehhzX","./handleBattleshipBttnClick":"4YxkI","./handleDestroyerBttnClick":"1zjy0","./handleFrigateBttnClick":"4QZ7c","./handleSuperdreadnoughtBttnClick":"iL6A7"}],"2p5Tx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/isCorrectNumberOfShips":"21vDW","../components/doesShipPlacementOverlap":"iGKQQ","../components/checkAllShipsInPlace":"6FcJc","./handleCarrierMouseEnter":"g59nL","./handleCarrierMouseLeave":"ehhzX","./handleBattleshipBttnClick":"4YxkI","./handleDestroyerBttnClick":"1zjy0","./handleFrigateBttnClick":"4QZ7c","./handleSuperdreadnoughtBttnClick":"iL6A7","../components/accumulatePlayerShipCoords":"9lJOj"}],"21vDW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const doesShipPlacementOverlap = function(shipLength_, currentAxis_, currentX_, currentY_) {
    ...
    let playerShipsCoords = JSON.parse(localStorage.getItem("playerShipsCoords") ?? "");
...
},{"./renderStartButton":"bfo7r","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./renderStarsInPlayerBoard":"aZtIU"}],"bfo7r":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../utilities/elementCreators":"H4ivl","./handlePlayerClickOnCompMisses":"2HlWb","./handlePlayerClickOnCompShips":"uEG8W","../data/shipNames":"ekPmF","../components/randomizeAndStoreShipNames":"et96r","../components/renderCompBoard":"5e8Dz","../components/placeCompShipsOnBoard":"dU4Hs","../data/compShipsPlacementChoicesArr":"k7Vwa"}],"2HlWb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components/announceGameWinner":"503Ay","../components/computersTurn":"kGr2j","../utilities/elementCreators":"H4ivl","./handlePlayerClickOnCompMisses":"2HlWb","../components/renderBattleMessage":"hDATR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"503Ay":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./preventClicksAfterWin":"8zxk8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./restartGame":"kObX3"}],"8zxk8":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const renderBattleMessageElem = function(currentCellCoord_, currentShipSymbol_, towardsCombatant_, hitOrMiss_) {
    ...
    if (towardsCombatant_ === "comp") {
        ...
        if (hitOrMiss_ === "hit") {
            ...
            if (compSuperdreadnought.includes(currentCellCoord_)) //displays hit on superdreadnought with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${hitsPrecursorString} the superdreadnought PNS ${havenShipNames.superdreadnought}! ${(0, _battleTexts.battleTexts).hitsOnComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnComp.length)]}`))(battleMessageElem);
            else if (compCarrier.includes(currentCellCoord_)) //displays hit on carrier with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${hitsPrecursorString} the carrier PNS ${havenShipNames.cruiser}! ${(0, _battleTexts.battleTexts).hitsOnComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnComp.length)]}`))(battleMessageElem);
            else if (compBattleship.includes(currentCellCoord_)) //displays hit on battleship with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${hitsPrecursorString} the battleship PNS ${havenShipNames.battleship}! ${(0, _battleTexts.battleTexts).hitsOnComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnComp.length)]}`))(battleMessageElem);
                ...
                (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${hitsPrecursorString} the destroyer PNS ${destroyer1Coords.includes(currentCellCoord_) ? havenShipNames.destroyers[0] : havenShipNames.destroyers[1]}! ${(0, _battleTexts.battleTexts).hitsOnComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnComp.length)]}`))(battleMessageElem);
                ...
                (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${hitsPrecursorString} the frigate PNS ${frigate1Coords.includes(currentCellCoord_) ? havenShipNames.frigates[0] : havenShipNames.frigates[1]}! ${(0, _battleTexts.battleTexts).hitsOnComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnComp.length)]}`))(battleMessageElem);
            }
        } else if (hitOrMiss_ === "miss") //player attacking computer misses
        (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`${playerName}'s turn: ${(0, _battleTexts.battleTexts).missesByPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).missesByPlayer.length)]}`))(battleMessageElem);
    } else if (towardsCombatant_ === "player") {
        if (hitOrMiss_ === "hit") {
            //if computer attacking player registers a hit
            if (currentShipSymbol_ === "S") //displays hit on superdreadnought with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${hitsPrecursorString} the superdreadnought RMNS ${manticoreShipNames.superdreadnought}! ${(0, _battleTexts.battleTexts).hitsOnPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnPlayer.length)]}`))(battleMessageElem);
            else if (currentShipSymbol_ === "C") //displays hit on carrier with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${hitsPrecursorString} the carrier RMNS ${manticoreShipNames.cruiser}! ${(0, _battleTexts.battleTexts).hitsOnPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnPlayer.length)]}`))(battleMessageElem);
            else if (currentShipSymbol_ === "B") //displays hit on battleship with randomized text
            (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${hitsPrecursorString} the battleship RMNS ${manticoreShipNames.battleship}! ${(0, _battleTexts.battleTexts).hitsOnPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnPlayer.length)]}`))(battleMessageElem);
                ...
                //displays hit on destroyer with randomized text
                //only need to check one destroyer
                (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${hitsPrecursorString} the destroyer RMNS ${destroyer1Coords.includes(currentCellCoord_) ? manticoreShipNames.destroyers[0] : manticoreShipNames.destroyers[1]}! ${(0, _battleTexts.battleTexts).hitsOnPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnPlayer.length)]}`))(battleMessageElem);
                ...
                //displays hit on frigate with randomized text
                //only need to check one frigate
                (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${hitsPrecursorString} the frigate RMNS ${frigate1Coords.includes(currentCellCoord_) ? manticoreShipNames.frigates[0] : manticoreShipNames.frigates[1]}! ${(0, _battleTexts.battleTexts).hitsOnPlayer[Math.floor(Math.random() * (0, _battleTexts.battleTexts).hitsOnPlayer.length)]}`))(battleMessageElem);
            }
        } else if (hitOrMiss_ === "miss") //computer attacking player misses
        (0, _elementCreators.pipe)((0, _elementCreators.addTextToElem)(`Haven's turn: ${(0, _battleTexts.battleTexts).missesByComp[Math.floor(Math.random() * (0, _battleTexts.battleTexts).missesByComp.length)]}`))(battleMessageElem);
    }
};

},{"../utilities/elementCreators":"H4ivl","../data/battleTexts":"6YoE9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6YoE9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const genRandCompAttackGuess = function() {
    ...
    let compAttackGuesses = JSON.parse(localStorage.getItem("compAttackGuesses") ?? "");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aZtIU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g59nL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4YxkI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./handleBattleshipCellClick":"8b5eS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleBattleshipMouseEnter":"20QiK","./handleBattleshipMouseLeave":"byPhE","./handleSuperdreadnoughtBttnClick":"iL6A7","./handleCarrierBttnClick":"38NmJ","./handleDestroyerBttnClick":"1zjy0","./handleFrigateBttnClick":"4QZ7c"}],"8b5eS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./handleDestroyerCellClick":"3xwCD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleDestroyerMouseEnter":"9ER26","./handleDestroyerMouseLeave":"7Pn09","./handleSuperdreadnoughtBttnClick":"iL6A7","./handleCarrierBttnClick":"38NmJ","./handleBattleshipBttnClick":"4YxkI","./handleFrigateBttnClick":"4QZ7c"}],"3xwCD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components/checkAllShipsInPlace":"6FcJc","../components/doesShipPlacementOverlap":"iGKQQ","../components/isCorrectNumberOfShips":"21vDW","../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleDestroyerMouseEnter":"9ER26","./handleDestroyerMouseLeave":"7Pn09","./handleBattleshipBttnClick":"4YxkI","./handleCarrierBttnClick":"38NmJ","./handleFrigateBttnClick":"4QZ7c","./handleSuperdreadnoughtBttnClick":"iL6A7","../components/accumulatePlayerShipCoords":"9lJOj"}],"9ER26":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./handleFrigateCellClick":"cP3IQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleFrigateMouseEnter":"3BZaH","./handleFrigateMouseLeave":"eaXxI","./handleSuperdreadnoughtBttnClick":"iL6A7","./handleCarrierBttnClick":"38NmJ","./handleBattleshipBttnClick":"4YxkI","./handleDestroyerBttnClick":"1zjy0"}],"cP3IQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../components/checkAllShipsInPlace":"6FcJc","../components/doesShipPlacementOverlap":"iGKQQ","../components/isCorrectNumberOfShips":"21vDW","../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleFrigateMouseEnter":"3BZaH","./handleFrigateMouseLeave":"eaXxI","./handleBattleshipBttnClick":"4YxkI","./handleCarrierBttnClick":"38NmJ","./handleDestroyerBttnClick":"1zjy0","./handleSuperdreadnoughtBttnClick":"iL6A7","../components/accumulatePlayerShipCoords":"9lJOj"}],"3BZaH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","./handleSuperdreadnoughtCellClick":"6MyCS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./handleSuperdreadnoughtMouseEnter":"qHolt","./handleSuperdreadnoughtMouseLeave":"4nkbf","./handleCarrierBttnClick":"38NmJ","./handleDestroyerBttnClick":"1zjy0","./handleFrigateBttnClick":"4QZ7c","./handleBattleshipBttnClick":"4YxkI"}],"6MyCS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../components/checkAllShipsInPlace":"6FcJc","../components/doesShipPlacementOverlap":"iGKQQ","../components/isCorrectNumberOfShips":"21vDW","./handleSuperdreadnoughtMouseEnter":"qHolt","./handleSuperdreadnoughtMouseLeave":"4nkbf","./handleBattleshipBttnClick":"4YxkI","./handleCarrierBttnClick":"38NmJ","./handleDestroyerBttnClick":"1zjy0","./handleFrigateBttnClick":"4QZ7c","../components/accumulatePlayerShipCoords":"9lJOj"}],"qHolt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../utilities/elementCreators":"H4ivl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9lJOj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3f75x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
